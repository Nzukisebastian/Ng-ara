...
public class Uploadimage extends AppCompatActivity implements View.OnClickListener{
    ...
    public static final String UPLOAD_URL = "http://10.0.2.2/imageupload/upload.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choose = (ImageView) findViewById(R.id.buttonChoose);
        upload = (ImageView) findViewById(R.id.buttonUpload);
